# USB Token Private Key Export Script (Fixed)
...
if ($ListCertificates) {
    ...
    Write-Host "   .\export-private-key-fixed.ps1 -OutputPath 'my-certificate.pfx'" -ForegroundColor White
    exit 0
}
...
if ($certificates.Count -eq 0) {
    ...
    Write-Host "   4. Run: .\export-private-key-fixed.ps1 -ListCertificates" -ForegroundColor White
    exit 1
}
